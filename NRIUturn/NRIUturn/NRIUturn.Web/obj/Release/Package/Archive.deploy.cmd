...
echo. "%MSDeployPath%\msdeploy.exe" -source:archiveDir='%RootPath%Archive' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%RootPath%Archive.SetParameters.xml" %_MsDeployAdditionalFlags%
"%MSDeployPath%\msdeploy.exe" -source:archiveDir='%RootPath%Archive' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%RootPath%Archive.SetParameters.xml" %_MsDeployAdditionalFlags%
)
goto :eof
