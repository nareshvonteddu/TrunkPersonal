...
{
    public class IndiaEducationViewModel : Screen, IIndiaEducationViewModel, IHandle<IndiaEducationGetDataEvent>, IHandle<IndiaEducationGetSubPostsEvent>, IHandle<IndiaEducationInsertMainPostEvent>, IHandle<IndiaEducationInsertReplyPostEvent>, IHandle<LoginEvent>, IHandle<IndiaEducationGetFiltersEvent>
    {
        ...
        public void Handle(IndiaEducationGetDataEvent message)
        {
        ...
        public void Handle(IndiaEducationGetSubPostsEvent message)
        {
        ...
        public void Handle(IndiaEducationInsertMainPostEvent message)
        {
        ...
        public void Handle(IndiaEducationInsertReplyPostEvent message)
        {
            if (message.IsSuccess == true)
            {
                PostSelected();
        ...
        public IndiaEducationViewModel(IDataLayer dataLayer, IEventAggregator eventAgregator, IUser user, 
            IndianCities indianCities, IndianStates states)
        {
            ModuleId = "2";
            DisplayName = "IndiaEducation";
        ...
        public void Handle(IndiaEducationGetFiltersEvent message)
        {
            ObservableCollection<Dictionary<string, string>> result = message.Output;
    ...
    public interface IIndiaEducationViewModel:IScreen
    { }
}
