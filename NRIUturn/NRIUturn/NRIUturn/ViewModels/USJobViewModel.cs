...
{
    public class USJobViewModel : Screen, IUSJobViewModel,IHandle<USJobGetDataEvent>,IHandle<USJobGetSubPostsEvent>,IHandle<USJobInsertMainPostEvent>,IHandle<USJobInsertReplyPostEvent>,IHandle<LoginEvent>, IHandle<USJobGetFiltersEvent>
    {
        ...
        public void Handle(USJobGetDataEvent message)
        {
        ...
        public void Handle(USJobGetSubPostsEvent message)
        {
        ...
        public void Handle(USJobInsertMainPostEvent message)
        {
        ...
        public void Handle(USJobInsertReplyPostEvent message)
        {
            if (message.IsSuccess == true)
            {
                PostSelected();
        ...
        public USJobViewModel(IDataLayer dataLayer, IEventAggregator eventAgregator, IUser user,
        ...
        public void Handle(USJobGetFiltersEvent message)
        {
            ObservableCollection<Dictionary<string, string>> result = message.Output;
    ...
    public interface IUSJobViewModel:IScreen
    { }
}
