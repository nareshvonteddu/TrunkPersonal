...
{
    public class USHouseViewModel : Screen, IUSHouseViewModel, IHandle<USHouseGetDataEvent>, IHandle<USHouseGetSubPostsEvent>, IHandle<USHouseInsertMainPostEvent>, IHandle<USHouseInsertReplyPostEvent>, IHandle<LoginEvent>, IHandle<USHouseGetFiltersEvent>
    {
        ...
        public void Handle(USHouseGetDataEvent message)
        {
        ...
        public void Handle(USHouseGetSubPostsEvent message)
        {
        ...
        public void Handle(USHouseInsertMainPostEvent message)
        {
        ...
        public void Handle(USHouseInsertReplyPostEvent message)
        {
            if (message.IsSuccess == true)
            {
                PostSelected();
        ...
        public USHouseViewModel(IDataLayer dataLayer, IEventAggregator eventAgregator, IUser user,
        ...
        public void Handle(USHouseGetFiltersEvent message)
        {
            ObservableCollection<Dictionary<string, string>> result = message.Output;
    ...
    public interface IUSHouseViewModel:IScreen
    { }
}
