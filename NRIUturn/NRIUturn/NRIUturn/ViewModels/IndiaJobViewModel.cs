...
{
    public class IndiaJobViewModel : Screen, IIndiaJobViewModel, IHandle<IndiaJobGetDataEvent>, IHandle<IndiaJobGetSubPostsEvent>, IHandle<IndiaJobInsertMainPostEvent>, IHandle<IndiaJobInsertReplyPostEvent>, IHandle<LoginEvent>, IHandle<IndiaJobGetFiltersEvent>
    {
        ...
        public void Handle(IndiaJobGetDataEvent message)
        {
        ...
        public void Handle(IndiaJobGetSubPostsEvent message)
        {
        ...
        public void Handle(IndiaJobInsertMainPostEvent message)
        {
        ...
        public void Handle(IndiaJobInsertReplyPostEvent message)
        {
            if (message.IsSuccess == true)
            {
                PostSelected();
        ...
        public IndiaJobViewModel(IDataLayer dataLayer, IEventAggregator eventAgregator, IUser user,
            IndianCities indianCities, IndianStates states)
        {
            ModuleId = "4";
            DisplayName = "IndiaJob";
        ...
        public void Handle(IndiaJobGetFiltersEvent message)
        {
            ObservableCollection<Dictionary<string, string>> result = message.Output;
    ...
    public interface IIndiaJobViewModel:IScreen
    { }
}
