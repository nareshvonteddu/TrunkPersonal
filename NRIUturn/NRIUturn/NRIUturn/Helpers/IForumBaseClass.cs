...
{
    //public class ForumBaseClass : Screen, IForumBaseClass
    //{
    ...
    public interface IForumBaseClass
    {
        IUser User { get; set; }
        Visibility NewPostButtonVisible { get; set; }
        Visibility PostButtonVisible { get; set; }
        Visibility ReplyButtonVisible { get; set; }
        Visibility ReplyPostVisible { get; set; }
        Post ReplyPost { get; set; }
        string ModuleId { get; set; }
        IEventAggregator EventAgregator { get; set; }
        IDataLayer DataLayer { get; set; }
        Visibility OldPostsVisible { get; set; }
        Visibility NewPostVisible { get; set; }
        Post NewPost { get; set; }
        Post SelectedPost { get; set; }
        ObservableCollection<Post> Posts { get; set; }
        //void Handle(LoginEvent message);
        //void Handle(GetDataEvent message);
        //void Handle(GetSubPostsEvent message);
        //void Handle(InsertMainPostEvent message);
        //void Handle(InsertReplyPostEvent message);
        //void NewPostClick();
        //void ReplyPostClick();
        //void SaveNewPost();
        //void PostSelected();
        ...
        //void ShowHideReplyPostButton();
        //void ShowHideNewPostButton();
        //void ShowHidePostCancelButtons();
    }
}
